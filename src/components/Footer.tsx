...
import { Github as GitHub, Linkedin, Mail, Phone, MapPin, ArrowUp } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 md:px-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:[email address removed]" className="text-gray-400 hover:text-white transition-colors">
                  [email address removed]
                </a>
              </li>
              <li className="flex items-start gap-3">
                <Phone size={20} className="text-blue-400 mt-1" />
                <a href="tel:+917494016678" className="text-gray-400 hover:text-white transition-colors">
                  +91-7494016678
                </a>
              </li>
            </ul>
        ...
        <div className="pt-8 mt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} Kishlay Kumar. All rights reserved.
          </p>
          <button 
            onClick={scrollToTop}
